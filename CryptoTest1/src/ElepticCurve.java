...
public class ElepticCurve {
    ...
    ElepticCurve(BigInteger a, BigInteger b, BigInteger p) {
        this.a = a;
        this.b = b;
        this.p = p;
    }

    ElepticCurve(String a, String b, String p) {
    ...
    public BigInteger[] uncompressPoint(BigInteger px, BigInteger py) {
        ...
        BigInteger y = (px.pow(3).mod(p).add(a.multiply(px)).add(b)); // find y^2
